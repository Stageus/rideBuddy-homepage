...
const UserIdCheckInput = ({ userId, setUserId, errorMessage, setErrorMessage, status, isAllFieldsRequiredError, checkIdDuplication }) => (
  <div>
...
export default UserIdCheckInput;
